...
<div class="risk-container">
    <div class="risk-header">
        <div class="header-left">
            <h2 class="header-title">Add New Risk</h2>
            <p class="header-subtitle">Create a new risk assessment entry</p>
        </div>
    ...
    <form method="POST" action="<?= $_SESSION['base_uri'] ?>/risk-register/store" class="risk-form">
        <!-- Basic Information -->
